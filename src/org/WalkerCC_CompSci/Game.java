...
public class  Game {
    ...
    private boolean CheckForWin() {
        ...
        }  if(this.gameBoard.spaces[3] == this.gameBoard.spaces[4] && this.gameBoard.spaces[4] == this.gameBoard.spaces[5]){
            if(this.gameBoard.spaces[3] != Space.EMPTY){
                return true;
            }
        }  if(this.gameBoard.spaces[6] == this.gameBoard.spaces[7] && this.gameBoard.spaces[7] == this.gameBoard.spaces[8]){
        ...
        }  if(this.gameBoard.spaces[2] == this.gameBoard.spaces[4] && this.gameBoard.spaces[4] == this.gameBoard.spaces[6]){
        ...
        }  if(this.gameBoard.spaces[1] == this.gameBoard.spaces[4] && this.gameBoard.spaces[4] == this.gameBoard.spaces[7]){
            if(this.gameBoard.spaces[1] != Space.EMPTY){
                return true;
            }
        }  if(this.gameBoard.spaces[2] == this.gameBoard.spaces[5] && this.gameBoard.spaces[5] == this.gameBoard.spaces[8]){
            if(this.gameBoard.spaces[2] != Space.EMPTY){
                return true;
            }
        }
    ...
    private boolean IsFilled(){
        ...
        for (int i = 0; i < gameBoard.spaces.length; i++){
            ...
            if ((this.gameBoard.spaces[0] != Space.EMPTY) &&
                    (this.gameBoard.spaces[0] != Space.EMPTY) &&
